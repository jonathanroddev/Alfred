...
public interface CommunityService {
    ...
    Community getCommunity(String uuid) throws NotFoundException, BadRequestException;
    CommunityEntity getCommunityEntity(String uuid) throws NotFoundException, BadRequestException;
